                  ...
                  {editingNote?.id === note.id ? (
                    ...
                    <div>
                      ...
                      <div className="content-buttons">
                        ...
                        <button onClick={() => handleDeleteNote(note.id)} className="btn-danger">
                          🗑️ Delete
                        </button>
                      </div>
                    </div>
          ...
          <div className="content-list">
            {filteredQuotes.length === 0 ? (
              ...
              filteredQuotes.map(quote => (
                <div key={quote.id} className="content-card">
                  {editingQuote?.id === quote.id ? (
                    ...
                    <div>
                      ...
                      <div className="content-buttons">
                        ...
                        <button onClick={() => handleDeleteQuote(quote.id)} className="btn-danger">
                          🗑️ Delete
                        </button>
                      </div>
                    </div>
