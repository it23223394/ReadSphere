      ...
      <div className="page">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="mt-1 text-muted">Quick view of your reading journey and shortcuts.</p>
          </div>
          <div className="flex gap-2">
            <Link to="/bookshelf" className="btn btn-item">📚 Bookshelf</Link>
            <Link to="/notes-quotes" className="btn btn-item">📝 Notes & Quotes</Link>
            <Link to="/tracking" className="btn btn-toolbar">📈 Tracker</Link>
          </div>
        </div>
